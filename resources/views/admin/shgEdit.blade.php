...
<div class="row">
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Edit Shg</h3>
    ...
    <div class="box-body table-responsive no-padding">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="{{route('admin.shg.post')}}" method="post" enctype="multipart/form-data">
              @csrf
              <input type="hidden" name="id" value="{{$shgs->id}}">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $shgs->name }}" placeholder="Name">
                  </div>
                  @if ($errors->has('name'))
                                <span class="invalid-feedback text-danger" role="alert">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contact" value="{{ $shgs->contact }}" placeholder="Name">
                  </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ $shgs->password }}" placeholder="Password">
                  </div>
