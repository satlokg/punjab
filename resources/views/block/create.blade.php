...
<section class="content">
    <div class="row">
    <div class="box">
    <form class="form-horizontal" action="{{route('block.store')}}" method="post" enctype="multipart/form-data">
              @csrf
    ...
    <div class="col-sm-5">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Enter block name" value="{{old('block_name')}}" name="block_name">
