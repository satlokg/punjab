  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="pull-right">
          <a href="{{route('district.shg')}}" class="btn btn-success" title="Add Shg">
    ...
    <div class="box-body table-responsive no-padding">
          ...
          <div class="box box-info">
            <!-- form start -->
            <form class="form-horizontal" action="{{route('district.shg.post')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="box-body">
