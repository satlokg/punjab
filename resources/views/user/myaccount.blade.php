...
<!-- Mirrored from demo.hasthemes.com/flone-preview/flone/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Aug 2019 16:40:06 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="panel-body">
                                    <div class="myaccount-info-wrapper">
                                        ...
                                        <div class="billing-back-btn">
                                            ...
                                            <div class="billing-btn">
                                                <button id="button" type="button">Continue</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).on('click', '.billing-btn', function () {
        ...
        var name = $(this).data('vakue');
        alert(name);
        //var table_id = $(this).data('value');
             //alert(comment_id);
        var me = $(this);
            $.ajax({
                type: "POST",
                ...
                async: true,
                url: SITE_URL + '/recent-delete',
                dataType: 'JSON',
                success: function (data) {
//                    console.log(data.id['p_id']);
                           $('#div'+comment_id).remove();
                },
                error: function (err) {
 ...
 //  for the Accordion 
$("#most_recent_act_icon").click(function() {
    $("#lea_most_recent_act").slideToggle("slow");
});
</script> -->