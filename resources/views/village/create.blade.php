...
<section class="content">
    <div class="row">
    <div class="box">
    <form class="form-horizontal" action="{{route('village.store')}}" method="post" enctype="multipart/form-data">
              @csrf
    ...
    <div class="col-sm-5">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Enter village name" value="{{old('village_name')}}" name="village_name">
